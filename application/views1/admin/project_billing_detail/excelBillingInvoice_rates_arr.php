...
<!-- data souce Project_billing_trans@get_project_summary -->
        <table class="table table-hover table-bordered table-condensed" id="billing" border="0">
            ...
            <tr>
                ...
                <td colspan="3">&nbsp;</td>
                <td colspan="3" align="center" style="text-align:center;"><font face="arial"><strong><?php echo date('d-M-y'); ?></strong></font></td>
                
                <!-- <td colspan="5">&nbsp;</td>
                <td align="right" style="padding-right:50px;"><font face="arial"><strong><?php echo date('d-M-y'); ?></strong></font></td> -->
                <!-- <td colspan="5" align="right" style="padding-right:50px;"><font face="arial"><strong><?php echo date('d-M-y'); ?></strong></font></td> -->
            <?php $cnt_row++ ?>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td colspan="5" width="60%"><font size="3" face="arial"><strong><?php echo t($combine_billing->cb_title); ?></strong></font></td>
            </tr>
            <?php $cnt_row++ ?>
            <tr>
                <td>&nbsp;</td>
                <td colspan="4"><?php echo t($combine_billing->cb_address); ?></td>
                <td colspan="1">&nbsp;</td>
            <?php $cnt_row++ ?>
            </tr>
            <?php for ($i=0; $i < 9; $i++) : ?>
            ...
            <?php $ewt = 0.00; ?>
            <?php $vat = 0.00; ?>
            <?php $total_billing = 0.00; ?>

            <?php foreach ($billing_ids as $key => $pbi): ?>


                <?php $proj_billing = 0.00; ?>
                <?php $project_billing_info = $project_billings[$key]; ?>
                <?php $project = $this->projects->get($project_billing_info->project_id, TRUE) ?>
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="5">
                        <font face="Arial" size="8pt">
                        <strong>
                            <?php echo t($project->description); ?>
                        </strong>
                        </font>
                    </td>
                    <?php $cnt_row++ ?>
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <font face="Arial" size="8pt">
                            <?php echo ! empty($project_billing_info->remarks) ? t($project_billing_info->remarks) : '';  ?>
                            ( <?php echo date('F j, Y', strtotime($project_billing_info->date_start)) . ' - ' . date('F j, Y', strtotime($project_billing_info->date_end)) ?> )
                        </font>
                    </td>
                    <?php $cnt_row++ ?>
                </tr>
                ...
                <?php if ($bill->project_bill_id == $pbi): ?>
                                    ...
                                    <?php $proj_billing += $subtotal_billing; ?>
                ...
                <?php $proj_ewt = floatval($proj_billing) * 0.02; ?>
                <?php $proj_vat = floatval($proj_billing) * 0.12; ?>
            ...
            <?php if ($project_billing_info->is_wt_tax == 1): ?>
                <?php $proj_billing -= floatval($proj_ewt); ?>
                <?php $total_billing -= floatval($ewt); ?>
                <tr>
                    <td>&nbsp;</td>
                    <td colspan="3" style="text-align:right; font-weight: normal;">Less 2% EWT</td>
                    <!-- <td style="text-align:right; font-weight: bold;">&nbsp;</td> -->
                    <td style="text-align:right; font-weight: normal;"><?php echo nf($proj_ewt) ?></td>
                    <td>&nbsp;</td>
                <?php $cnt_row++ ?>
                </tr>
            <?php endif ?>
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="2" style="text-align:left; font-weight: bold; font-size:15px;">&nbsp;</td>
                <td style="text-align:right; font-weight: bold;">Total</td>
                <td style="text-align:right; font-weight: bold; font-size:15px; border-bottom: 1px double #000;"><?php echo nf(floatval($proj_billing)) ?></td>
                <td>&nbsp;</td>
            <?php $cnt_row++ ?>
            </tr>
            <tr>
