...
<!-- data souce Project_billing_trans@get_project_summary -->
        <table class="table table-hover table-bordered table-condensed" id="billing" border="0">
            ...
            <tr>
                <td>&nbsp;</td>
                <td colspan="3"><strong><?php echo t($combine_billing->cb_title); ?></strong></td>                
                <td colspan="3" align="center" style="text-align:center"><strong><?php echo date('d-M-y'); ?></strong></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td colspan="3"><strong><?php echo t($combine_billing->cb_address); ?></strong></td>
                <td colspan="2">&nbsp;</td>
            </tr>
            <?php for ($i=0; $i < 11; $i++) : ?>
            <tr>
            ...
            <?php foreach ($projects as $key => $value): ?>
                ...
                <?php $project = $this->projects->get($value, TRUE) ?>
