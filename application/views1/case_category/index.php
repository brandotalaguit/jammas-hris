    		...
    		<div class="col-sm-4">
		        <div class="box-tools" style="padding: 10px 10px 10px 0px">
		            ...
		            <?php #if (isset($search_form)): ?>
			            <?php $this->load->view('case_category/search_form'); ?>
		            <?php #endif ?>
						...
						<tr <?php echo $this->session->flashdata('id') == $case_category->case_category_id ? "class='success'" : ''; ?> >
							...
							<td>
								<div class="btn-group btn-block">
									<?php echo btn_edit('case_category/'. $case_category->case_category_id . '/edit');?>
									<?php echo btn_delete('case_category/'. $case_category->case_category_id . '/delete');?>
								</div>
							</td>
						</tr>
					<?php endforeach ?>
