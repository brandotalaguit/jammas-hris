...
<?php  
	...
	// dump($project);
	$subtotal_company_share = $subtotal_employee_share = $subtotal_share = $company_share = $employee_share = $total_share = 0;
	$subtotal = array();
	$title = FALSE;
?>
...
<?php foreach ($result as $row): ?>
		    ...
		    <table class="table table-condensed table-hover" border="1" width="100%">
			    <thead>
					...
					<tr>
				        ...
				        <th rowspan="2" width='15%' class="text-center">PHILHEALTH NO.</th>
				        <th rowspan="2" width='10%' class="text-center">GROSS INCOME</th>
	...
	<!-- start result here -->
				<tr>
					...
					<td class="text-right">
	                    <?php echo nf($row->gross_income); ?> <br>
					</td>
					
					<td class="text-right">
	                    <?php echo $row->employer_share_philhealth; ?> <br>
					</td>
					<td class="text-right">
	                    <?php echo $row->employee_share_philhealth; ?> <br>
					</td>
					<td class="text-right">
	                    <?php echo $row->total_monthly_premium_philhealth; ?> <br>
					</td>
				</tr>
				<?php $company_share += $row->employer_share_philhealth; ?>
				<?php $employee_share += $row->employee_share_philhealth; ?>
				<?php $total_share += $row->total_monthly_premium_philhealth; ?>
				<?php $title = $row->title; ?>
	<!-- end result here -->
	<?php endif ?>
...
<?php endforeach ?>
		...
		<thead>
			<tr>
				<th colspan="8" class="text-center">S U M M A R Y</th>
			</tr>
			<tr>
		        <th rowspan="2" class="text-center">#</th>
		        <th rowspan="2" colspan="4" class="text-center">PROJECT</th>
	    		<th colspan="4" width="" class="text-center">C O N T R I B U T I O N</th>
		    </tr>
	    	<tr>
		        <th width='11%' class="text-center">Company Share</th>
			...
			<tr>
				<td><?php echo ++$ctr; ?></td>
				<td colspan="4"><?php echo $summary['project']; ?></td>
