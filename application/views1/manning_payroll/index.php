...
<div class="modal fade" id="contribution-modal">
    ...
    <?php /* echo form_open(NULL, ['role' => 'form', 'target' => '_blank', 'id' => 'frmContribution']); ?>
<div class="row">
    <div class="col-md-4">
        ...
        <div class="col-sm-7">
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    ...
                    <?= form_dropdown(
                                    'project_id', $projects, $this->input->post('project_id'),
                                    "class='form-control' style='width:99%' id='project_id' data-url='" . base_url('manning_payroll') ."'");
                        ?>
            ...
            <button class="btn btn-default disabled"> <?= $this->input->post() ? 'Search Matched Found' : 'Matched Record' ?>: <?= nf($total_result, 0) ?></button>
            </div>

            <p>
                <?= anchor('manning_payroll/edit'
