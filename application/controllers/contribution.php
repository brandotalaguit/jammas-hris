...
class Manning_payroll extends Admin_Controller
{
    ...
    public function philhealth_contribution()
    {
        ...
        foreach ($proj as $row) 
        {
            ...
            $result = $this->manning_payroll_deduction_m->fields($field_arr)->group_by('G.project_id, manning_id')->get_manning_payroll_deduction();
            $project[] = array(
        ...
        $this->load_view('manning_payroll/philhealth_contribution');
    }
