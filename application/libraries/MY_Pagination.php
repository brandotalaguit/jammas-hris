...
class MY_Pagination extends CI_Pagination
{
    ...
    function MY_Pagination ()
    {
        ...
        $config_style['full_tag_open'] = '<ul class="pagination pull-right no-print no-margin">';
        $config_style['full_tag_close'] = '</ul>';
        
        $config_style['first_link'] = TRUE;
        $config_style['last_link'] = TRUE;

        $config_style['first_link'] = '&larr; First';
        $config_style['first_tag_open'] = '<li class="prev page">';
        $config_style['first_tag_close'] = '</li>';
         
        $config_style['last_link'] = 'Last &rarr;';
        $config_style['last_tag_open'] = '<li class="next page">';
        $config_style['last_tag_close'] = '</li>';

        $config_style['next_link'] = 'Next &raquo;';
        $config_style['next_tag_open'] = '<li class="next">';
        $config_style['next_tag_close'] = '</li>';

        $config_style['prev_link'] = '&laquo; Previous';
