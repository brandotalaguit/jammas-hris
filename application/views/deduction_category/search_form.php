...
<form class="form-inline" role="form" method="post" action="<?php echo site_url('deduction_category') ?>">

			<div class="input-group">
	            <select name="by" id="by" class="form-control" style="width:40%">
	            	<option value="deduction_category_code">Code</option>
	            	<!-- <option value="position_code">Position Code</option> -->
	            	<option value="deduction_category">Category</option>
	            </select>
