...
<?php echo form_open(site_url('loan_term/'.$this->uri->segment(2).'/edit'), array('class' =>'form-horizontal', 'role' => 'form')); ?>
...
<div class="row">
	<div class="col-sm-6">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="interest_rate" id="interest_rate" class="form-control" placeholder="No. of Months" value="<?php echo set_value('interest_rate', $loan_term->interest_rate);?>">
			</div>
		</div>
